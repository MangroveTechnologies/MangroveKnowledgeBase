...
| Signal | Type | Description |
|--------|------|-------------|
| `bullish_engulfing` | TRIGGER | Bullish engulfing candlestick pattern |
| `bearish_engulfing` | TRIGGER | Bearish engulfing candlestick pattern |
| `hammer` | TRIGGER | Hammer candlestick pattern |
| `inverted_hammer` | TRIGGER | Inverted hammer candlestick pattern |
| `doji` | TRIGGER | Doji candlestick pattern |
| `morning_star` | TRIGGER | Morning star three-bar reversal pattern |
| `evening_star` | TRIGGER | Evening star three-bar reversal pattern |
| `shooting_star` | TRIGGER | Shooting star candlestick pattern |
