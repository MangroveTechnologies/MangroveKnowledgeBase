...
**Base URL:** `https://api.mangrovedeveloper.ai/api/v1/crypto-assets`
...
curl -H "Authorization: Bearer $TOKEN" \
  "https://api.mangrovedeveloper.ai/api/v1/crypto-assets/query?approved_only=true&min_score=70&limit=50"
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  "https://api.mangrovedeveloper.ai/api/v1/crypto-assets/all?approved=true&min_score=70&limit=100"
```
