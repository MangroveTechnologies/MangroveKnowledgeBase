...
Available servers: [MangroveMarkets](/mcp-servers/mangrove-markets), [MangroveTrader](/mcp-servers/mangrove-trader), [MangroveKnowledgeBase](/mcp-servers/mangrove-kb), [openclaw-executive-functions](/mcp-servers/openclaw-executive-functions).
...
## Path F — Claude Code plugin

If you live in the terminal, install a Mangrove plugin and use slash commands.
...
See [Claude Code plugins](/plugins/claude-code) for the full plugin catalog.
...
- See the [System Overview](/system-overview) for how the pieces fit together.
