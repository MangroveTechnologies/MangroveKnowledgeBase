...
`mangrove_kb/graph.py` is a query layer over `ontology/signal-indicator-ontology.json` -- 678 nodes
and 2192 edges, generated from the source, shipped inside the wheel.
