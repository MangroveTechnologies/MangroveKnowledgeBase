...
`mangrove_kb/graph.py` is a query layer over `ontology/signal-indicator-ontology.json` -- 650 nodes
and 2064 edges, generated from the source, shipped inside the wheel.
