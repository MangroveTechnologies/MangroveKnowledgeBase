...
`mangrove_kb/graph.py` is a query layer over `ontology/signal-indicator-ontology.json` -- 361 nodes
and 1111 edges, generated from the source, shipped inside the wheel.
