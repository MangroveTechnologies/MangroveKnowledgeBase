...
`mangrove_kb/graph.py` is a query layer over `ontology/signal-indicator-ontology.json` -- 571 nodes
and 1760 edges, generated from the source, shipped inside the wheel.
