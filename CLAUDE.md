...
`mangrove_kb/graph.py` is a query layer over `ontology/signal-indicator-ontology.json` -- 427 nodes
and 1267 edges, generated from the source, shipped inside the wheel.
