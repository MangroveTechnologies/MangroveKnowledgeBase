...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-370%20nodes%20%C2%B7%201156%20edges-42a7c6.svg" alt="Graph: 370 nodes, 1156 edges">
...
And a **knowledge graph built from that source** — 370 nodes and 1156 edges saying what each
...
| Map | middle | 370 nodes, 1156 edges |
...
370 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 370 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 307 of 370 nodes are `ratified`, so
