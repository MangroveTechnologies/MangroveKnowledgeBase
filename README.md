...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-361%20nodes%20%C2%B7%201113%20edges-42a7c6.svg" alt="Graph: 361 nodes, 1113 edges">
...
And a **knowledge graph built from that source** — 361 nodes and 1113 edges saying what each
...
| Map | middle | 361 nodes, 1113 edges |
...
361 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 361 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 307 of 361 nodes are `ratified`, so
