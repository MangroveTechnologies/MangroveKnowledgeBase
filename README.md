...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-365%20nodes%20%C2%B7%201150%20edges-42a7c6.svg" alt="Graph: 365 nodes, 1150 edges">
...
And a **knowledge graph built from that source** — 365 nodes and 1150 edges saying what each
...
| Map | middle | 365 nodes, 1150 edges |
...
365 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 365 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 307 of 365 nodes are `ratified`, so
