...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-650%20nodes%20%C2%B7%202064%20edges-42a7c6.svg" alt="Graph: 650 nodes, 2064 edges">
...
And a **knowledge graph built from that source** — 650 nodes and 2064 edges saying what each
...
| Map | middle | 650 nodes, 2064 edges |
...
650 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 650 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 308 of 650 nodes are `ratified`, so
