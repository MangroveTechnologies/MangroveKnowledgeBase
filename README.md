...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-427%20nodes%20%C2%B7%201216%20edges-42a7c6.svg" alt="Graph: 427 nodes, 1216 edges">
...
And a **knowledge graph built from that source** — 427 nodes and 1216 edges saying what each
...
| Map | middle | 427 nodes, 1216 edges |
...
427 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 427 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 307 of 427 nodes are `ratified`, so
