...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-678%20nodes%20%C2%B7%202192%20edges-42a7c6.svg" alt="Graph: 678 nodes, 2192 edges">
...
And a **knowledge graph built from that source** — 678 nodes and 2192 edges saying what each
...
| Map | middle | 678 nodes, 2192 edges |
...
678 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 678 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 308 of 678 nodes are `ratified`, so
