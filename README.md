...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-729%20nodes%20%C2%B7%202373%20edges-42a7c6.svg" alt="Graph: 729 nodes, 2373 edges">
...
And a **knowledge graph** — 729 nodes and 2373 edges, with two halves on one schema. One is compiled
...
| Map | middle | 729 nodes, 2373 edges |
...
729 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 729 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 323 of 729 nodes are `ratified`, so
