...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/graph-715%20nodes%20%C2%B7%202329%20edges-42a7c6.svg" alt="Graph: 715 nodes, 2329 edges">
...
And a **knowledge graph built from that source** — 715 nodes and 2329 edges saying what each
...
| Map | middle | 715 nodes, 2329 edges |
...
715 nodes at once is a picture, not an answer. **show only** keeps part of the graph around the
...
on zoom — at 715 nodes, off is often clearer than on.
...
it just has a canonical replacement. Nothing else is ringed: 308 of 715 nodes are `ratified`, so
