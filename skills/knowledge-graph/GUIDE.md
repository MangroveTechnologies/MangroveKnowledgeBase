...
`"indicator"` (71), `"signal"` (218) and `"technical-analysis"` (304 of 571) — legal, occasionally
...
**Trap:** `status` is on the node, not the edge, and only 2 of 571 nodes are deprecated. Check it
...
```python
kg.find(under="market foundations", limit=None)                 # 131 nodes
