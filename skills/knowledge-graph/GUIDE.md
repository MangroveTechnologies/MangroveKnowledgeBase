...
`"indicator"` (71), `"signal"` (218) and `"technical-analysis"` (333 of 650) — legal, occasionally
...
**Trap:** `status` is on the node, not the edge, and only 2 of 650 nodes are deprecated. Check it
