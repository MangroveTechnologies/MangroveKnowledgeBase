"""mangrove-signals: Open-source trading signals and technical indicators library.
...
from mangrove_signals import indicators
from mangrove_signals import signals
