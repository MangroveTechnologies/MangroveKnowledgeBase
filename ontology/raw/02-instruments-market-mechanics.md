...
tags: ["instruments", "derivatives", "leverage", "crypto", "futures", "options", "margin", "spot-market", "settlement", "price-determination", "contango", "backwardation", "rollover", "expiration", "perpetual-swaps", "funding-rate", "crypto-derivatives", "calls", "puts", "Greeks", "delta", "gamma", "theta", "vega", "Black-Scholes", "options-pricing", "implied-volatility", "binomial-model", "liquidation", "margin-call", "DEX", "CEX", "AMM", "tokenomics", "blockchain", "forex", "currency-pairs", "pips", "FX-sessions"]
source_type: trading
---
