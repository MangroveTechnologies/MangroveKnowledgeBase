...
tags: ["quantitative", "statistics", "volatility", "mean-reversion", "seasonality", "machine-learning", "calendar-effects", "time-of-day", "statistical-patterns", "GARCH", "volatility-clustering", "volatility-forecasting", "regime-switching", "pairs-trading", "z-score", "cointegration", "statistical-arbitrage", "breakout", "Donchian", "volatility-expansion", "range-break", "autocorrelation", "momentum", "time-series", "cross-sectional", "ML", "features", "classification", "overfitting", "factor-investing", "carry", "yield", "roll-yield", "risk-premium"]
source_type: trading
---
