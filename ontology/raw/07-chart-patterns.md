...
tags: ["patterns", "technical-analysis", "candlesticks", "charts", "chart-patterns", "reversal", "continuation", "Doji", "Hammer", "Engulfing", "reversal-patterns", "inside-bar", "outside-bar", "pin-bar", "narrow-range", "consolidation", "head-shoulders", "double-top", "triangle", "flag", "wedge", "cup-handle", "algorithmic", "pattern-detection", "TA-Lib", "systematic", "reliability", "failure-modes", "false-breakout", "pattern-failure", "context", "trend-alignment", "pattern-validity", "filtering", "completion", "confirmation", "breakout", "entry-timing"]
source_type: trading
---
